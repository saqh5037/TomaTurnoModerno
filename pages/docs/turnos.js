        ...
        >
          ...
          <HStack spacing={6} align="start" mb={6}>
            ...
            <Circle
              ...
              flexShrink={0}
            >
              <Icon as={FaTicketAlt} fontSize="36px" />
            </Circle>
...
export async function getStaticProps() {
  ...
  const moduleData = fullDocumentation.find(m => m.moduleId === 'turnos');
...
export default function ProtectedTurnosDocumentation({ moduleData }) {
  return (
    <ProtectedRoute>
      <TurnosDocumentation moduleData={moduleData} />
    </ProtectedRoute>
  );
}

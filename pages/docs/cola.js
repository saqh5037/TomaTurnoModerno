        ...
        >
          ...
          <HStack spacing={6} align="start" mb={6}>
            ...
            <Circle
              ...
              flexShrink={0}
            >
              <Icon as={FaListOl} fontSize="36px" />
            </Circle>
...
export async function getStaticProps() {
  ...
  const moduleData = fullDocumentation.find(m => m.moduleId === 'cola');
...
export default function ProtectedColaDocumentation({ moduleData }) {
  return (
    <ProtectedRoute>
      <ColaDocumentation moduleData={moduleData} />
    </ProtectedRoute>
  );
}

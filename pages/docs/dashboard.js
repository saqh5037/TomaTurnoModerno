...
import {
  ...
  FaClock, FaBook, FaImage, FaChevronRight, FaHome, FaInfoCircle, FaTachometerAlt
} from 'react-icons/fa';
import ReactMarkdown from 'react-markdown';
import ProtectedRoute from '../../components/ProtectedRoute';
import { GlassCard, ModernHeader, fadeInUp, slideInFromLeft } from '../../components/theme/ModernTheme';

const DashboardDocumentation = ({ moduleData }) => {
      ...
      <Container maxW="container.xl">
        ...
        >
          ...
          <Box
            ...
            bg="green.200"
          >
            <Box height="100%" width="0%" bg="green.500" />
          </Box>
          ...
          <HStack spacing={6} align="start" mb={6}>
            ...
            <Circle
              ...
              flexShrink={0}
            >
              <Icon as={FaTachometerAlt} fontSize="36px" />
            </Circle>
...
export async function getStaticProps() {
  ...
  const moduleData = fullDocumentation.find(m => m.moduleId === 'dashboard');
...
export default function ProtectedDashboardDocumentation({ moduleData }) {
  return (
    <ProtectedRoute>
      <DashboardDocumentation moduleData={moduleData} />
    </ProtectedRoute>
  );
}

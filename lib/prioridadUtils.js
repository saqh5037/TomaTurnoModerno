...
/**
 * Determina si un tipo de atención se considera "especial" para routing por cubículo
 * Especial = cualquier tipo que NO sea General (MuyEspecial, Prioritario, PrioritarioRiesgo, RiesgoCaida)
 */
export function isEspecialTurn(tipoAtencion) {
  return tipoAtencion !== 'General';
}

 ...
 * Solo MuyEspecial (presos → cubículo 6) requiere SPECIAL. El resto puede atenderse en GENERAL.
 *
 * Tabla de routing por enum de cubículo:
 *   - MuyEspecial      → solo SPECIAL (cub 6)
 *   - Prioritario      → cualquier cubículo
 *   - PrioritarioRiesgo → cualquier cubículo (preferencia cubs 1, 2)
 *   - RiesgoCaida      → cualquier cubículo (preferencia cubs 1, 2)
 *   - General          → cualquier cubículo
 */
export function requiresSpecialCubicle(tipoAtencion) {
  return tipoAtencion === 'MuyEspecial';
}
